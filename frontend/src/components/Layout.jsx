  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        <div className="p-4 md:p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0 flex items-center justify-between gap-3">
          <div className="flex flex-col items-center gap-2 min-w-0 flex-1 w-full">
            <Logo size="lg" to="/admin/dashboard" className="flex-shrink-0" />
            <div className="text-center w-full px-2">
              ...
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mt-1">لوحة التحكم</p>
            </div>
          </div>
      ...
      <div className="w-full md:pr-64">
        <header className="md:hidden flex items-center justify-between gap-2 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 sticky top-0 z-30">
          <button onClick={() => setOpen(true)} className="flex-shrink-0 p-1">
            <Menu size={24} />
          </button>
          <div className="flex-1 flex justify-center">
            <Logo size="sm" to="/admin/dashboard" className="flex-shrink-0" />
          </div>
          <button onClick={toggleTheme} className="flex-shrink-0 p-1">{isDark ? <Sun size={20} /> : <Moon size={20} />}</button>
        </header>
