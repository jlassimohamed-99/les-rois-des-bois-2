          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center md:items-start">
              <div className="mb-4 flex justify-center md:justify-start w-full">
                <Logo size="md" showText={true} to="/shop" clickable={true} />
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 text-center md:text-right">نصنع الأثاث بمواد عالية الجودة مع حرفية دقيقة وتسليم سريع ودفع آمن.</p>
            </div>
            <div>
